...
BOT_TOKEN = environ.get('BOT_TOKEN', '5626153444:AAHqq7HFlZ3JIegBPkbYK7wwKr6MTzQU2S0')
...
AUTH_CHANNEL = environ.get('AUTH_CHANNEL', '-1001601591799')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Ato filter vps server")
